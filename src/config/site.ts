...
export const siteConfig = {
  name: "کاوِنتادور",
  nameEn: "Kaventador",
  tagline: "یادگیری برنامه‌نویسی، پروژه‌محور و رایگان",
  description:
    "کاوِنتادور پلتفرم آموزش پروژه‌محور برنامه‌نویسی به زبان فارسی است؛ آموزش رایگان و حرفه‌ای جاوا، جاوااسکریپت، JavaFX، اسپرینگ، ری‌اکت و نکست‌جی‌اس با تمرکز بر ساخت پروژه‌های واقعی.",
  url: process.env.NEXT_PUBLIC_SITE_URL ?? "https://kaventador.ir",
  locale: "fa_IR",
  direction: "rtl",
  email: "info@kaventador.ir",
  keywords: [
    "آموزش برنامه نویسی",
    "آموزش جاوا",
    "آموزش جاوااسکریپت",
