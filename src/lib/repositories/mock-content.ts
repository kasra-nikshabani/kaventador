/**
 * پیاده‌سازی درون‌حافظه‌ای لایه ریپازیتوری.
 *
 * با `DATA_SOURCE=mock` فعال می‌شود و برای اجرای پروژه بدون دیتابیس
 * به‌کار می‌آید — دمو، آزمون دستی، یا نگاه اول به پروژه. داده‌اش با هر
 * ری‌استارت به حالت اولیه برمی‌گردد.
 *
 * خروجی‌ها همیشه کپی‌اند تا هیچ مصرف‌کننده‌ای نتواند مخزن را ناخواسته
 * تغییر دهد — همان رفتاری که دیتابیس واقعی دارد.
 */
...
/* گره‌زدن به قرارداد — انحراف امضا خطای کامپایل می‌دهد. */
