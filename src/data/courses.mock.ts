...
export const coursesMock: Course[] = [
  ...
  defineCourse({
    ...
    level: "intermediate",
    status: "published",
    pricing: { type: "paid", amount: 890_000, originalAmount: 1_290_000 },
    progress: "ongoing",
  ...
  defineCourse({
    ...
    level: "intermediate",
    status: "published",
    pricing: { type: "paid", amount: 690_000 },
    progress: "completed",
    studentCount: 5610,
    rating: 4.7,
    ratingCount: 733,
  ...
  defineCourse({
    ...
    level: "intermediate",
    status: "published",
    pricing: { type: "paid", amount: 490_000 },
    progress: "ongoing",
  ...
  defineCourse({
    ...
    level: "advanced",
    status: "published",
    pricing: { type: "paid", amount: 1_490_000, originalAmount: 1_990_000 },
    progress: "upcoming",
